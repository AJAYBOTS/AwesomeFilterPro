...
async def next_page(bot, query):
    ...
    btn.insert(1, 
        [
            InlineKeyboardButton('ɢʀᴏᴜᴘ', url='https://t.me/+7GHtRs8wT4Y2ODM9'),
            InlineKeyboardButton('ᴄᴏɴᴛᴀᴄᴛ', url='https://t.me/AJMOVIES_4U')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ FILES OCHAY CHUDU MOWA BRO ♥️')
            else:
        ...
        return await query.answer('♥️ FILES OCHAY CHUDU MOWA ♥️')
        ...
        if groupids is None:
            ...
            return await query.answer('♥️ FILES OCHAY CHHUDU MOWA ♥️')
        buttons = []
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇs 🤖', url='https://t.me/AJMOVIEES_4U'),
            InlineKeyboardButton('💥 ᴍᴏᴠɪᴇs ♥️', url='https://t.me/+7GHtRs8wT4Y2ODM9')
            ],[
            InlineKeyboardButton('💞 sᴜᴘᴘᴏʀᴛ 💞', url='https://t.me/AJMOVIES_4U'),
            InlineKeyboardButton('👩‍💻 ʀᴇᴘᴏ ✨', url='https://GitHub.Com/AJAYBOTS/AwesomeFilterPro'),
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('🙄 ᴏᴡɴᴇʀ 🙄', url='https://t.me/AJMOVIES_4U'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇs 🤖', url='https://t.me/AJMOVIES_4U'),
        ],[
            InlineKeyboardButton('👩‍💻 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 👩‍💻', url='https://GitHub.Com/AJAYBOTS/AwesomeFilterPro'), #Please Change your bot username
